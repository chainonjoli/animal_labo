...
const CHARACTER_TABLE = [
  ...
  { n:31, animal:'こじか',  group:'MOON',  name:'リーダーとなるこじか' },
  { n:32, animal:'猿',      group:'EARTH', name:'気分屋の猿' },
  { n:33, animal:'チータ',  group:'SUN',   name:'足腰の強いチータ' },
  { n:34, animal:'たぬき',  group:'MOON',  name:'大器晩成のたぬき' },
  { n:35, animal:'ゾウ',    group:'SUN',   name:'悠然と構えるゾウ' },
  { n:36, animal:'虎',      group:'EARTH', name:'慈悲深い虎' },
  { n:37, animal:'こじか',  group:'MOON',  name:'しっかり者のこじか' },
  { n:38, animal:'猿',      group:'EARTH', name:'つき合い上手な猿' },
  { n:39, animal:'チータ',  group:'SUN',   name:'品格のあるチータ' },
  { n:40, animal:'たぬき',  group:'MOON',  name:'頼りになるたぬき' },
  { n:41, animal:'ライオン',group:'SUN',   name:'感情的なライオン' },
  { n:42, animal:'ゾウ',    group:'SUN',   name:'まっしぐらに突き進むゾウ' },
